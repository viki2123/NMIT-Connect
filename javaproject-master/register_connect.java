...
public class register_connect implements Initializable {
   ...
   {
    this.combolabel.setText("semester selected:"+ combolabel.getValue().toString());
   
   }*/
   
   @FXML
   void resigter1(ActionEvent event) throws Exception{
	   Main m = new Main();
